...
Public Class Form4
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lblNomJoueur.Text = "Joueur : " & NomDuJoueur
        ChargerImages()
        MélangerCartes()
        InitialiserGrille()
    End Sub
    ...
    Public Function ChargerImages()
        ...
        Dim idsPossibles() As String = {"fool", "jester", "sun", "tarot", "chariot"}
    ...
    Private Sub InitialiserGrille()
        Dim dosCarte As Image = ChargerImage("Images\back.jpg")
            ...
            If refID <> dernierID Then 'Si les IDs sont différents
                ...
                AddHandler t.Tick, Sub()
                                       For Each pb In cartesRetournees
                                           pb.Image = ChargerImage("Images\back.jpg")
                                       Next
